...
public class MiniLottoNGTest {
    ...
    public static boolean warnIsDisplayed(){
        boolean warn = driver.findElement(By.xpath("(//div[contains(.,'Serwer tymczasowo niedostępny. Spróbuj ponownie później.')])[14]")).isDisplayed();
        return warn;
    }
...
//    }
    ...
    public void EuroJackpot() throws InterruptedException {
        ...
        try {
            driver.findElement(By.xpath("(//div[contains(.,'Serwer tymczasowo niedostępny. Spróbuj ponownie później.')])[14]"));
        } catch (Exception e){
            Thread.sleep(10000);
        } finally {
            passwordInput.sendKeys(Keys.ENTER);
...
//        if (driver.findElement(By.xpath("(//div[contains(.,'Serwer tymczasowo niedostępny. Spróbuj ponownie później.')])[14]")).isDisplayed()){
//            Thread.sleep(10000);
//        } else{
//            return;
//        }
